...
def predict(image3D, sam_model=sam_model, points=None, prev_masks=None, num_clicks=5):
    ...
    gt3D = load_gt3d('/risk2/SAM-Med3D/visual/visualization_union_train_turbo_continue6/val_data/COLON/1.3.6.1.4.1.9328.50.4.0067_gt3D.nii.gz')
...
iface = gr.Interface(
    ...
    examples=["/risk2/SAM-Med3D/visual/visualization_union_train_turbo_continue6/val_data/COLON/1.3.6.1.4.1.9328.50.4.0067_image3D.nii.gz",
     "/risk2/SAM-Med3D/visual/visualization_union_train_turbo_continue6/val_data/COLON/1.3.6.1.4.1.9328.50.4.0431_image3D.nii.gz",
     #'/dataset/val_data_copy/COLON/imagesTr/1.3.6.1.4.1.9328.50.4.0067.nii.gz',
    "/risk2/SAM-Med3D/visual/visualization_union_train_turbo_continue6/val_data/LIVER/liver_88_image3D.nii.gz",
    "/risk2/SAM-Med3D/visual/visualization_union_train_turbo_continue6/val_data/CLINIC/dataset6_CLINIC_0041_data_image3D.nii.gz",
     "/risk2/SAM-Med3D/visual/visualization_union_train_turbo_continue6/val_data/COLON/1.3.6.1.4.1.9328.50.4.0680_image3D.nii.gz",
     "/risk2/SAM-Med3D/visual/visualization_union_train_turbo_continue6/val_data/VERSE/verse518_image3D.nii.gz",
    "/risk2/SAM-Med3D/visual/visualization_union_train_turbo_continue6/val_data/COLON/1.3.6.1.4.1.9328.50.4.0538_image3D.nii.gz",
    "/risk2/SAM-Med3D/visual/visualization_union_train_turbo_continue6/val_data/COLON/1.3.6.1.4.1.9328.50.4.0141_image3D.nii.gz",
    "/risk2/SAM-Med3D/visual/visualization_union_train_turbo_continue6/val_data/COLON/1.3.6.1.4.1.9328.50.4.0031_image3D.nii.gz",
    "/risk2/SAM-Med3D/visual/visualization_union_train_turbo_continue6/val_data/verse19/sub-verse412_split-verse290_ct_image3D.nii.gz",
"/risk2/SAM-Med3D/visual/visualization_union_train_turbo_continue6/val_data/verse20/sub-verse509_dir-iso_ct_image3D.nii.gz",
    "/risk2/SAM-Med3D/visual/visualization_union_train_turbo_continue6/val_data/COLON/1.3.6.1.4.1.9328.50.4.0127_image3D.nii.gz",
        "/risk2/SAM-Med3D/visual/visualization_union_train_turbo_continue6/val_data/COLON/1.3.6.1.4.1.9328.50.4.0762_image3D.nii.gz",
