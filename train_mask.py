...
parser.add_argument('--task_name', type=str, default='test_only')
parser.add_argument('--click_type', type=str, default='random')
parser.add_argument('--multi_click', action='store_true', default=False)
parser.add_argument('--model_type', type=str, default='vit_b_ori')
parser.add_argument('--checkpoint', type=str, default='/mnt/risk2/SAM-Med3D/work_dir/union_train_turbo_loramask_rank4_continue3/sam_model_dice_best.pth')
parser.add_argument('--lora_ckpt', type=str, default='/mnt/risk2/SAM-Med3D/work_dir/union_train_turbo_loramask_rank4_continue3/lora_params_dice_best.safetensors', help='path to LoRA checkpoint')
...
class BaseTrainer:
    ...
    def init_checkpoint(self, ckp_path):
        ...
        if last_ckpt:
            if self.args.multi_gpu:
                self.model.module.sam.load_state_dict(last_ckpt['model_state_dict'], strict=True)
            else:
                self.model.sam.load_state_dict(last_ckpt['model_state_dict'], strict=True)
