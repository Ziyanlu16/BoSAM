...
parser.add_argument('--checkpoint', type=str, default='/mnt/risk2/SAM-Med3D/weights/BoSAM.pth')
parser.add_argument('--lora_ckpt', type=str, default='/mnt/risk2/SAM-Med3D/weights/lora_params.pth', help='path to LoRA checkpoint')
